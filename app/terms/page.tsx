            ...
            <div className="prose prose-invert max-w-none space-y-8 text-muted-foreground">
              <section>
                ...
                <p className="leading-relaxed">
                  By accessing and using AI Reels ("the Service"), you accept and agree to be bound
                  by the terms and provision of this agreement. If you do not agree to these Terms
                  of Service, please do not use our Service.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  AI Reels provides an AI-powered platform that generates video reels automatically
                  based on user-provided topics. The Service includes script generation, audio
                  narration, visual creation, and video compilation.
                </p>
              </section>

              <section>
                <h2 className="mb-4 text-2xl font-semibold text-foreground">3. User Accounts</h2>
                <h3 className="mb-2 text-xl font-semibold text-foreground">3.1 Account Creation</h3>
                <p>
              ...
              <section>
                ...
                <ul className="list-disc space-y-2 pl-6">
                  ...
                  <li>
                    Use the Service to create content that is defamatory, hateful, or discriminatory
                  </li>
                  <li>
                    Resell or redistribute content generated through the Service without proper
                    licensing
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <h3 className="mb-2 text-xl font-semibold text-foreground">5.1 User Content</h3>
                <p>
                  You retain ownership of content you create using the Service. By using the
                  Service, you grant us a license to use, store, and process your content as
                ...
                <p>
                  ...
                  responsible for ensuring that generated content complies with platform guidelines
                  and applicable laws.
                </p>
              </section>
              ...
              <section>
                ...
                <h3 className="mb-2 text-xl font-semibold text-foreground">6.1 Free Plan</h3>
                <p>
                  We offer a free plan with limited features. Free plan users may have watermarked
                  videos and usage limitations.
                </p>

                <h3 className="mb-2 mt-4 text-xl font-semibold text-foreground">6.2 Paid Plans</h3>
                <p>
                  Paid subscriptions are billed on a recurring basis. You agree to pay all fees
                  associated with your subscription. Fees are non-refundable except as required by
                  law.
                </p>
              ...
              <section>
                ...
                <p>
                  ...
                  by AI Reels and protected by international copyright, trademark, and other
              ...
              <section>
                ...
                <p>
                  To the maximum extent permitted by law, AI Reels shall not be liable for any
              ...
              <section>
                ...
                <p>
                  ...
                  Service immediately, without prior notice, for conduct that we believe violates
