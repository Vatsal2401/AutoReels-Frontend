          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
              <p className="text-lg leading-relaxed">
                AI Reels is revolutionizing the way content creators produce video content. We
                believe that everyone should be able to create professional, engaging video reels
                without the need for expensive equipment, editing skills, or even appearing on
                camera.
              </p>

              <h2 className="mt-8 text-2xl font-semibold text-foreground">Our Mission</h2>
              <p>
                Our mission is to democratize video content creation by making it accessible to
                everyone. We use cutting-edge AI technology to generate complete video reels in just
                60 seconds - from script to final video, all automatically.
              </p>

              <h2 className="mt-8 text-2xl font-semibold text-foreground">What We Do</h2>
              <p>AI Reels uses advanced artificial intelligence to:</p>
              ...
              <p>
                We understand that content creation can be time-consuming and expensive. That's why
                we've built a platform that eliminates the need for:
              </p>
              <ul className="list-disc space-y-2 pl-6">
              ...
              <p>
                ...
                experience. Our platform is constantly evolving, and we're always working to improve
                the quality and speed of our video generation technology.
              </p>

              <p className="mt-8 text-lg">
                Join thousands of creators who are already using AI Reels to grow their audience and
                create viral content. Start creating today - no credit card required.
              </p>
            </div>
          </div>
        </section>
